...
const Hero = ()=> {
    return (
        <section className="hero-container min-h-[100dvh] flex justify-center items-start pt-24 relative overflow-hidden">
            ...
            <div className="text-container flex flex-col gap-6 w-full mt-4 mx-auto max-w-[1000px] px-6 lg:pl-[10%] lg:px-0">
                ...
                <p className="hero-desc text-text text-[1.2rem] lg:text-[1rem] text-left max-w-[400px] leading-[1.8] mb-12 border-l border-green pl-5">
                ...
                <div className="hero-cta flex flex-col lg:flex-row gap-6 font-mono font-extrabold tracking-widest">
